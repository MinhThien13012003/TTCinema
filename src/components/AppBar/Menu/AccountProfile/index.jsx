...
const AccountProfile = () => {
  ...
  const menuItems = [
    ...
    { id: 'member', label: 'Thành viên Cinestar', icon: <Stars /> },
      ...
      <Box sx={{ display: 'flex', mt: 8 }}>
        ...
        <Box
          sx={{
            width: sidebarWidth,
            flexShrink: 0,
            mr: 3, // <-- khoảng cách giữa sidebar và phần nội dung
            ...
            {menuItems.map((item) => (
              <ListItem
                ...
                sx={{
                  ...
                  '&:hover': {
                    bgcolor: activeTab === item.id ? '#fbbf24' : 'rgba(255, 255, 255, 0.1)'
                  }
                }}
              >
                <ListItemIcon sx={{ color: activeTab === item.id ? 'black' : 'white', minWidth: 32 }}>
                  {item.icon}
                </ListItemIcon>
                <ListItemText
                  primary={item.label}
        ...
        >
          <Container maxWidth="lg" sx={{ py: 3 }}>
            ...
            <Paper elevation={0} sx={{ p: 3, mb: 3, borderRadius: 2, border: '1px solid #e0e0e0' }}>
              <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 2.5, color: '#333' }}>
                Thông tin cá nhân
              </Typography>
              ...
              <Grid container spacing={2.5} sx={{ mb: 3 }}>
                {[
                  ...
                  { label: 'Ngày sinh', type: 'date', defaultValue: '2003-01-13' },
            ...
            <Paper elevation={0} sx={{ p: 3, borderRadius: 2, border: '1px solid #e0e0e0' }}>
              ...
              <Grid container spacing={2.5}>
                {['Mật khẩu cũ', 'Mật khẩu mới', 'Xác thực mật khẩu'].map((label, idx) => (
